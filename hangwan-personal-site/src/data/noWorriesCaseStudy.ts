const base = '/images/games/no-worries/case-study';

export const noWorriesCaseStudyImages = {
  hero: `${base}/hero.jpg`,
...
export const noWorriesStateOverviewImages: NoWorriesStateOverviewImage[] = [
  {
...
export const noWorriesDemoVideoId = '';

export type NoWorriesStateMachineVideo = {
  src: string;
  placeholder: string;
  aspectRatio?: string;
};

export const noWorriesStateMachineVideos: NoWorriesStateMachineVideo[] = [
  {
