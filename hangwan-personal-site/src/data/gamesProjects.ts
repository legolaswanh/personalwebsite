...
export const gamesProjects: ChapterProject[] = [
  {
    ...
    highlightTags: ['System Design'],
    tags: ['Core Loop Design', 'Resource Balance', 'Narrative Progression'],
  ...
  },
  {
    ...
    highlightTags: ['Narrative Exploration'],
    tags: ['Atmosphere', 'Environmental Storytelling'],
  ...
  },
  {
    ...
    highlightTags: ['Atmosphere'],
    tags: ['Exploration', 'Environmental Design'],
  ...
  },
  {
    ...
    highlightTags: ['Thematic Exploration'],
    tags: ['Identity', 'Reflective Play'],
  ...
  },
  {
    ...
    highlightTags: ['Recursive Mechanics'],
  ...
  },
  {
    ...
    highlightTags: ['Interaction Prototype'],
    tags: ['Perception', 'Rapid Prototyping'],
  ...
  },
  {
    ...
    highlightTags: ['Puzzle Logic'],
    tags: ['Narrative Design', 'Symbol Systems'],
  ...
  },
  {
    ...
    tags: ['Arcade Feel', 'Juice & Feedback'],
  ...
  },
  {
    ...
    highlightTags: ['Social Mechanics'],
    tags: ['Tabletop Design', 'Group Play'],
